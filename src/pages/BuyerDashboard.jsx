      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {view === "orders" && (
          <BuyerOrdersView
            ...
            setOrders={setOrders}
            user={user}
            onReview={(order) => { setReviewOrder(order); setReviewDialog(true); }}
            onReceipt={(order) => { setReceiptOrder(order); setReceiptDialog(true); }}
            onReturn={(order) => { setReturnOrder(order); setReturnDialog(true); }}
            onRetryPayment={(order) => setRetryPaymentOrder(order)}
          />
        )}
