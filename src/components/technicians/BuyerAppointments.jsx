...
const STATUS_STYLES = {
  pending:   { label: "Pending",   class: "bg-amber-50 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" },
  confirmed: { label: "Confirmed", class: "bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" },
  completed: { label: "Completed", class: "bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400" },
  cancelled: { label: "Cancelled", class: "bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-400" },
};
