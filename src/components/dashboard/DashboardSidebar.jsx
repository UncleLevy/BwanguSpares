    ...
    <>
      ...
      {mobileOpen && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-end p-3 border-b border-slate-100 dark:border-slate-700">
              <button onClick={() => setMobileOpen(false)} className="p-2 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">
                <X className="w-5 h-5" />
              </button>
            </div>
