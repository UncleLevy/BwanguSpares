                ...
                {isAuthenticated && (
                  <>
                    ...
                    {user?.role !== 'shop_owner' && user?.role !== 'admin' && (
                      <button onClick={() => window.location.href = createPageUrl("Cart")} className="relative p-2 text-slate-600 dark:text-slate-400 hover:text-blue-600 transition-colors">
